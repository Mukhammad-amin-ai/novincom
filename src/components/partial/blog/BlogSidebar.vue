    ...
    <div class="widget widget-cats">
      ...
      <ul>
        <li v-for="(cat, index) in blogCategories" :key="index">
          <router-link
            :to="{ path: '/blog/' + type, query: { category: cat.slug } }"
          >
            {{ cat.name }}
            <span>{{ cat.count }}</span>
          </router-link>
      ...
      <ul class="posts-list">
        <li>
          ...
          <div>
            ...
            <h4>
              <router-link to="/blog/single/default/cras-ornare-tristique-elit."
                >Aliquam tincidunt mauris eurisus.</router-link
              >
            </h4>
          </div>
        </li>
        <li>
          ...
          <div>
            ...
            <h4>
              <router-link to="/blog/single/default/cras-ornare-tristique-elit."
                >Cras ornare tristique elit.</router-link
              >
            </h4>
          </div>
        </li>
        <li>
          ...
          <div>
            ...
            <h4>
              <router-link to="/blog/single/default/cras-ornare-tristique-elit."
                >Vivamus vestibulum ntulla nec ante.</router-link
              >
            </h4>
          </div>
        </li>
        <li>
          ...
          <div>
            ...
            <h4>
              <router-link to="/blog/single/default/cras-ornare-tristique-elit."
                >Donec quis dui at dolor tempor interdum.</router-link
              >
            </h4>
          </div>
        </li>
