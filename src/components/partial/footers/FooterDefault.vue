          ...
          <div class="col-sm-6 col-lg-3">
            <div class="widget">
              ...
              <ul class="widget-list">
                <li>
                  <router-link to="/pages/about">About Molla</router-link>
                </li>
                <li>
                ...
                <li>
                  <router-link to="/pages/contact">Contact us</router-link>
                </li>
                <li>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="widget">
              ...
              <ul class="widget-list">
                ...
                <li>
                  <router-link to="/shop/cart">View Cart</router-link>
                </li>
                <li>
                  <router-link to="/shop/wishlist">My Wishlist</router-link>
                </li>
                <li>
                  <router-link to="/shop/dashboard">Track My Order</router-link>
                </li>
                <li>
                  <a href="#">Help</a>
                </li>
