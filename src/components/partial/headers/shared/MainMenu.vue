  ...
  <nav class="main-nav">
    <ul class="menu sf-arrows">
      ...
      <li :class="{ active: current == 'shop' }">
        <router-link to="/shop/sidebar/list" class="sf-with-ul"
          >Shop</router-link
        >
            ...
            <div class="col-md-6">
              <div class="menu-col">
                ...
                <ul>
                  ...
                  <li>
                    <router-link to="/product/gallery/beige-metal-hoop-tote-bag"
                      >Gallery</router-link
                    >
                  </li>
                  <li>
                    <router-link
                      ...
                      >Sticky Info</router-link
                    >
                  </li>
                  <li>
                    <router-link
                      to="/product/sidebar/beige-v-neck-button-cardigan"
                      >Boxed With Sidebar</router-link
                    >
                  </li>
                  <li>
                    <router-link
                  ...
                  <li>
                    <router-link
                      ...
                      >Masonry Sticky Info</router-link
                    >
                  </li>
                </ul>
              </div>
      ...
      <li :class="{ active: current == 'blog' }">
        ...
        <ul>
          ...
          <li>
            <router-link to="/blog/grid/grid-2" class="sf-with-ul"
              >Grid</router-link
            >
            <ul>
              <li>
          ...
          <li>
            <router-link to="/blog/masonry/masonry-2" class="sf-with-ul"
              >Masonry</router-link
            >
            <ul>
              <li>
          ...
          <li>
            <router-link to="/blog/mask/grid" class="sf-with-ul"
              >Mask</router-link
            >
            <ul>
              <li>
