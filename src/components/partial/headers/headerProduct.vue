            ...
            <div :class="isFullwidth ? 'container-fluid' : 'container'">
                <div class="header-left">
                    ...
                    <router-link to="/" class="logo">
                        <img src="../../../assets/newImg/logotypes/logo.svg" class="bg-transparent" alt="Molla Logo"
                            width="105" height="27" />
                    </router-link>
                </div>
                        ...
                        <div class="dropdown category-dropdown">
                            <a href="javascript:;" class="dropdown-toggle" title="Потратить бонусы">
                                <div class="drop-custom">
                                    <svg class="hover-menu" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3 18H21V16H3V18ZM3 13H21V11H3V13ZM3 6V8H21V6H3Z" fill="#333333" />
                                    </svg>
                                    <svg class="hover-close" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <nav class="side-nav">
                                    <ul class="menu-vertical sf-arrows">
                                        ...
                                        <li style="background-color: #f9f9f9"
                                            ...
                                            <router-link to="/shop/sidebar/3cols">Товары
                                            </router-link>
                                        </li>
