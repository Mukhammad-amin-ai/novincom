<template>
    <div class="products mb-3 content-overlay">
        <p class="no-results" v-if="products.length === 0 && loaded">No products matching your selection.</p>
        <div class="row">
...
<script>
import ProductTen from '../../../../components/elements/products/ProductTen.vue';
export default {
    components: {
        ProductTen
    },
