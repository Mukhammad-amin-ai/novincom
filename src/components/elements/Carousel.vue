<template>
  <div class="carousel">
    <div class="container items-center">
      <!-- -->
      <swiper :loop="true" :modules="modules" :navigation="showNavigation" :slides-per-view="1" :space-between="150"
          ...
          <div class="container swiper-item swiper_custom_item items-center">
            <div class="left-swiper-item">
              <div v-if="slide.image" class="right-swiper-item-img">
                <img format="webp" class="main-img" loading="lazy" :alt="slide.name" :src="slide.image" />
              </div>
            </div>
            <div class="right-swiper-item d-flex flex-column justify-content-center">
              ...
              <div class="w-100 d-flex justify-content-start">
                <router-link to="/sign_up" class="auth-btn text-white mb-2" style="white-space: nowrap">Вход / Регистрация
