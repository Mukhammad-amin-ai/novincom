    ...
    <div class="product product-2">
        <figure class="product-media">
            ...
            <div class="product-action-vertical" v-if="product.stock !== 0">
                <nuxt-link to="/shop/wishlist" class="btn-product-icon btn-wishlist added-to-wishlist"
            ...
            <div class="product-action product-action-dark" v-if="product.stock !== 0">
                <nuxt-link :to="'/product/default/' + product.slug" class="btn-product btn-cart btn-select text-center"
                    v-if="product.variants.length > 0"></nuxt-link>
        ...
        <div class="product-body">
            ...
            <template v-else>
                ...
                <template v-else>
                    ...
                    <div class="product-price" v-else>${{ minPrice.toFixed(2) }}&ndash;${{ maxPrice.toFixed(2) }}</div>
                </template>
            </template>
