  ...
  <div class="product product-7 text-center">
    <figure class="product-media">
      ...
      <!-- <div class="product-action" v-if="product.stock !== 0">
        <router-link :to="'/product/default/' + product.slug" class="btn btn-product btn-cart btn-select"
          v-if="product.variants.length > 0">
          <span>select options</span>
        </router-link>
        <a href="javascript:;" class="btn btn-product btn-cart" @click.prevent="addToCart({ product: product })" v-else>
